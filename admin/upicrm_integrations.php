    ...
    for($i=0; $i<=1; $i++) {
        ...
        <form method="post" class="form-inline" action="admin.php?page=upicrm_integrations">
           ...
           <div class="form-group">
               ...
               <input type="url" name="integration_domain" value="<?php echo $integration_domain; ?>" placeholder="http://" style="margin-right: 10px; height: 29px;" />
           </div>
           <div class="form-group">
        ...
        <!-- row -->
        <div class="LeadsRouteTable" class="row">
